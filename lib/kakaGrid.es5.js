...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var isNode$1 = typeof window === 'undefined' || typeof window.window === 'undefined';
    var arrayFind;
    var arrayFindIndex;
    var array = {
        get find() {
    ...
    var _a$1 = analyzeUserAgent(), IE = _a$1.IE, Chrome = _a$1.Chrome, Firefox = _a$1.Firefox, Edge = _a$1.Edge, Safari = _a$1.Safari;
    ...
    function getChainSafe(obj) {
        ...
        return applyChainSafe.apply(void 0, __spreadArray([obj, function (val, name) { return val[name]; }], names, false));
    }
    ...
    function getHeaderStateId() {
        return get('header.stateID');
    }
    ...
    function bindCellKeyAction$1(grid, cellId, _a) {
        ...
        acceptKeys = __spreadArray(__spreadArray([], acceptKeys, true), [KEY_ENTER, KEY_SPACE], false);
        return [
            // enter key down
    ...
    var Action = /** @class */ (function (_super) {
        ...
        Action.prototype.bindGridEvent = function (grid, cellId) {
            ...
            return __spreadArray(__spreadArray([], bindCellClickAction$1(grid, cellId, {
                action: actionMouse,
                mouseMove: mouseMove,
                mouseOut: mouseOut,
                mouseOver: mouseMove,
            }), true), bindCellKeyAction$1(grid, cellId, {
                action: action,
            }), true);
        };
            ...
            return [
                ...
                grid.listen(DG_EVENT_TYPE.MODIFY_STATUS_EDITABLEINPUT_CELL, function (cell) {
                    ...
                    if (range.start.col !== range.end.col ||
                        ...
                        input_1.style.top = "".concat((parseFloat(input_1.style.top) +
                            (rangeRect.top - baseRect.top)).toFixed(), "px");
                        input_1.style.left = "".concat((parseFloat(input_1.style.left) +
                            (rangeRect.left - baseRect.left)).toFixed(), "px");
                        input_1.style.width = "".concat(rangeRect.width.toFixed(), "px");
                        input_1.style.height = "".concat(rangeRect.height.toFixed(), "px");
                    }
    ...
    var BaseCheckEditor = /** @class */ (function (_super) {
        ...
        BaseCheckEditor.prototype.bindGridEvent = function (grid, cellId) {
            ...
            return __spreadArray(__spreadArray(__spreadArray([], bindCellClickAction$1(grid, cellId, {
                action: action,
                ...
                action: function (e) {
                    ...
                    for (var row = selRange.start.row; row <= selRange.end.row; row++) {
                        ...
                        var cellRange = grid.getCellRange(col, row);
                        if (!cellStartMap[cellRange.start.row]) {
                            cellStartMap[cellRange.start.row] = true;
                            action({
                                col: col,
                                row: row,
                            });
    ...
    var EventHandler = /** @class */ (function () {
        ...
        EventHandler.prototype.on = function (target, type, listener) {
            ...
            if (target.addEventListener) {
                target.addEventListener.apply(target, __spreadArray([type, listener], options, false));
            }
            var obj = {
                target: target,
                type: type,
        ...
        EventHandler.prototype.once = function (target, type, listener) {
            ...
            var id = this.on.apply(this, __spreadArray([target,
                type,
                function () {
                    var args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
            ...
            try {
                each(this._listeners, function (obj) {
                    ...
                    if (obj.target === target && obj.type === type) {
                        if (obj.target.removeEventListener) {
                            (_a = obj.target).removeEventListener.apply(_a, __spreadArray([obj.type,
                                obj.listener], obj.options, false));
                        }
                        list.push(obj);
                    }
                });
                ...
                list.forEach(function (obj) {
                    ...
                    if (obj.target.addEventListener) {
                        (_a = obj.target).addEventListener.apply(_a, __spreadArray([obj.type,
                            obj.listener], obj.options, false));
                    }
                });
            }
        ...
        EventHandler.prototype.fire = function (target, type) {
            ...
            each(this._listeners, function (obj) {
                var _a;
                if (obj.target === target && obj.type === type) {
                    (_a = obj.listener).call.apply(_a, __spreadArray([obj.target], args, false));
                }
            });
        };
    ...
    var hasMusselScrollbar = function () { var _a; return !!((_a = window.mussel) === null || _a === void 0 ? void 0 : _a.scrollbar); };
    var hasPerfectScrollbar = function () { return !!window.PerfectScrollbar; };
    ...
    var style$2 = {
        ...
        inject: styleInject,
        hasMusselScrollbar: hasMusselScrollbar,
        hasPerfectScrollbar: hasPerfectScrollbar,
    };
    ...
    var InlineInputElement = /** @class */ (function () {
        ...
        InlineInputElement.prototype.attach = function (grid, editor, col, row, value, inputValue) {
            ...
            input.style.paddingTop = "".concat(padding[0], "px");
            input.style.paddingRight = "".concat(padding[1], "px");
            input.style.paddingBottom = "".concat(padding[2], "px");
            input.style.paddingLeft = "".concat(padding[3], "px");
    ...
    var INPUT_CLASSNAME_ILE = "".concat(CLASSNAME_ILE, "__input");
    var DROPDOWN_CLASSNAME_ILE = "".concat(CLASSNAME_ILE, "__dropdown");
    var DROPDOWN_HIDDEN_CLASSNAME_ILE = "".concat(DROPDOWN_CLASSNAME_ILE, "--hidden");
    var DROPDOWN_SHOWN_CLASSNAME_ILE = "".concat(DROPDOWN_CLASSNAME_ILE, "--shown");
    var DROPDOWN_RIGHT_CLASSNAME_ILE = "".concat(DROPDOWN_CLASSNAME_ILE, "--right");
    var DROPDOWN_BOTTOM_CLASSNAME_ILE = "".concat(DROPDOWN_CLASSNAME_ILE, "--bottom");
    var DROPDOWN_ITEM_CLASSNAME_ILE = "".concat(DROPDOWN_CLASSNAME_ILE, "-item");
    var DROPDOWN_ITEM_EMPTY_CLASSNAME_ILE = "".concat(DROPDOWN_ITEM_CLASSNAME_ILE, "--empty");
    var DROPDOWN_ITEM_OTHER_CLASSNAME_ILE = "".concat(DROPDOWN_ITEM_CLASSNAME_ILE, "--other");
    var DROPDOWN_ITEM_FIRST_CLASSNAME_ILE = "".concat(DROPDOWN_ITEM_CLASSNAME_ILE, "--first");
    ...
    var InlineLookupElement = /** @class */ (function () {
        function InlineLookupElement() {
            ...
            this._input = this._lookup.querySelector(".".concat(INPUT_CLASSNAME_ILE));
            this._dropdown = this._lookup.querySelector(".".concat(DROPDOWN_CLASSNAME_ILE));
            this._bindInputEvents();
        }
        ...
        InlineLookupElement.prototype.attach = function (grid, editor, col, row, value, lookupRecords, inputValue) {
            ...
            lookup.style.top = "".concat(rect.top.toFixed(), "px");
            lookup.style.left = "".concat(rect.left.toFixed(), "px");
            lookup.style.width = "".concat(rect.width.toFixed(), "px");
            lookup.style.height = "".concat(rect.height.toFixed(), "px");
            ...
            handler.on(input, 'keydown', function (e) {
                ...
                if (keyCode === KEY_ESC) {
                    ...
                    if (n) {
                        ...
                        if (!next) {
                            var items = _this._dropdown.querySelectorAll(".".concat(DROPDOWN_ITEM_CLASSNAME_ILE));
                    ...
                    if (n) {
                        ...
                        if (!next) {
                            next = _this._dropdown.querySelector(".".concat(DROPDOWN_ITEM_CLASSNAME_ILE));
                            if (!isFocusable(next)) {
        ...
        InlineLookupElement.prototype._selectNode = function (node, isSelected) {
            if (node) {
                if (isSelected !== false) {
                    ...
                    this._input.dataset[LOOKUP_SELECT_VALUE] =
                        this._input.dataset[LOOKUP_BEFORE_VALUE];
                }
            }
            else {
                this._input.dataset[LOOKUP_SELECT_VALUE] =
    ...
    function normalize$1(options) {
        ...
        if (Array.isArray(options)) {
            return options.map(function (e) {
                return extend(e, { label: e.caption || e.label });
            });
        }
    ...
    function normalizeToFn(options) {
        if (typeof options === 'function') {
            return function (record) {
                return normalize$1(options(record));
            };
        }
        return function () { return normalize$1(options); };
    }
    var menuItems = {
    ...
    var ITEM_CLASSNAME_IME = "".concat(CLASSNAME_IME, "__menu-item");
    var HIDDEN_CLASSNAME_IME = "".concat(CLASSNAME_IME, "--hidden");
    var SHOWN_CLASSNAME_IME = "".concat(CLASSNAME_IME, "--shown");
    var EMPTY_ITEM_CLASSNAME_IME = "".concat(ITEM_CLASSNAME_IME, "--empty");
    ...
    function attachElement(element, rect, menu, autoWidth) {
        ...
        menu.style.width = autoWidth ? '' : "".concat(rect.width.toFixed(), "px");
    ...
    function openMenu(grid, editor, col, row, value, options, menu) {
        ...
        for (var i = 0; i < children.length; i++) {
            ...
            if (editor.autoPosition && i < focusIndex) {
                offset += offsetHeight;
            }
            allHeight += offsetHeight;
        }
        if (editor.autoPosition) {
        ...
        if (editor.autoPosition) {
            menu.style.transformOrigin = "center ".concat(offset, "px 0px");
        }
        attachElement(element, rect, menu, editor.autoWidth);
    ...
    var InlineMenuElement = /** @class */ (function () {
        ...
        InlineMenuElement.prototype._bindMenuEvents = function () {
            ...
            var handler = this._handler;
            var menu = this._menu;
            var stopPropagationOnly = function (e) { return event.cancel(e); }; // 为了不在grid中传播
        ...
        InlineMenuElement.prototype._onKeydownTab = function (menu, item, e) {
            ...
            if (!e.shiftKey) {
                if (!findNextSiblingFocusable(item)) {
                    var n = menu.querySelector(".".concat(ITEM_CLASSNAME_IME));
                    if (!isFocusable(n)) {
                ...
                if (!findPrevSiblingFocusable(item)) {
                    var items = menu.querySelectorAll(".".concat(ITEM_CLASSNAME_IME));
    ...
    function toNormalizeArray(iconProps) {
        ...
        return icons.map(function (icon) { return normalize(icon); });
    }
    ...
    var icons$2 = {
        toNormalizeArray: toNormalizeArray,
    ...
    function drawActionButton$1(grid, context, stateId, helper, _a) {
        var textBaseline = _a.textBaseline, font = _a.font, padding = _a.padding, appearance = _a.appearance, color = _a.color;
        var result = false;
        var info = {
            hoverOnButton: false,
            hoverOnCell: false,
        ...
        if (state) {
            ...
            if (info.hoverOnCell && state.mouseRelativePos) {
                var rect = context.getRect();
                var btnWidth = 32;
                rect = new Rect(rect.left + rect.width - btnWidth - iconPadding[1], rect.top, btnWidth, rect.height);
                info.hoverOnButton =
                ...
                state.mouseActive = info.hoverOnButton;
            }
        }
        if (appearance !== 'none' && isDefString(appearance)) {
            ...
            if (appearance === 'menulist-button') {
                ...
                icon = {
                    color: info.hoverOnButton ? 'rgba(0, 0, 0, .9)' : 'rgba(0, 0, 0, .54)',
                    path: 'M0 2 5 7 10 2z',
                    width: 10,
                };
            }
                ...
                icon = appearance(info.hoverOnButton, info);
            }
            else if (obj.isObject(appearance)) {
                icon = appearance;
            }
            else {
                window.console.warn("unsupported appearance:".concat(appearance));
            }
            if (icon) {
    ...
    var drawUtils = {
        drawActionButton: drawActionButton$1,
    };
    ...
    function loadIcons(icon, context, helper, callback) {
        ...
        if (icon) {
            if (isPromise(icon)) {
                ...
                var iconList = icons$2.toNormalizeArray(icon);
    ...
    function drawActionButton(grid, context, stateId, helper, style) {
        return drawUtils.drawActionButton(grid, context, stateId, helper, style);
    }
    ...
    var EventTarget = /** @class */ (function () {
        ...
        EventTarget.prototype.listen = function (type, listener) {
            var _this = this;
            var list = this[_$3].listeners[type] || (this[_$3].listeners[type] = []);
            list.push(listener);
            var id = eventTargetNextId++;
            this[_$3].listenerData[id] = {
                listener: listener,
                remove: function () {
                    delete _this[_$3].listenerData[id];
                    var index = list.indexOf(listener);
                    list.splice(index, 1);
                    if (!_this[_$3].listeners[type].length) {
                        delete _this[_$3].listeners[type];
                    }
                },
                type: type,
            };
        ...
        EventTarget.prototype.removeEventListener = function (type, listener) {
            ...
            each(this[_$3].listenerData, function (obj, id) {
        ...
        EventTarget.prototype.fireListeners = function (type) {
            ...
            var list = this[_$3].listeners[type];
            if (!list) {
                return [];
            }
            return list.map(function (listener) { return listener.call.apply(listener, __spreadArray([_this], args, false)); }).filter(isDef);
        };
        /**
         * @returns
         */
    ...
    var SwitchStyle$1 = /** @class */ (function (_super) {
    ...
    var EVENT_TYPE = BaseStyle$1.EVENT_TYPE;
    function of$7(columnStyle, record, StyleClassDef) {
        if (StyleClassDef === void 0) { StyleClassDef = Style$1; }
        if (columnStyle) {
    ...
    var BaseColumn = /** @class */ (function () {
        ...
        BaseColumn.prototype.onDrawCell = function (cellValue, info, context, grid) {
            var _this = this;
            var style = info.style, getRecord = info.getRecord, clearCellBase = info.clearCellBase, drawCellBorder = info.drawCellBorder, drawCellBase = info.drawCellBase, getCell = info.getCell, getContentHidden = info.getContentHidden;
            ...
            if (state.cellRange &&
                ...
                var actStyle = of$7(style, record, this.StyleClass);
            ...
            if (promise) {
                ...
                return promise.then(function (val) {
                    ...
                    var drawInternal = function () {
                        ...
                        clearCellBase();
                        var actStyle = of$7(style, _record, _this.StyleClass);
                        if (actStyle.bgColor) {
    ...
    var InlineMenuEditor = /** @class */ (function (_super) {
        ...
        function InlineMenuEditor(options) {
            ...
            _this._autoPosition = isDef(options.autoPosition)
        ...
        Object.defineProperty(InlineMenuEditor.prototype, "autoPosition", {
            get: function () {
                return this._autoPosition;
            },
            set: function (autoPosition) {
    ...
    var InlineTextAreaElement = /** @class */ (function () {
        ...
        InlineTextAreaElement.prototype.attach = function (grid, editor, col, row, value, inputValue) {
            ...
            input.style.top = "".concat(rect.top.toFixed(), "px");
            input.style.left = "".concat(rect.left.toFixed(), "px");
            input.style.minWidth = "".concat(rect.width.toFixed(), "px");
            input.style.width = input.style.minWidth;
            input.style.minHeight = "".concat(rect.height.toFixed(), "px");
    ...
    var RadioEditor = /** @class */ (function (_super) {
        ...
        function RadioEditor(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, options) || this;
            _this._group = options.group;
            _this._checkAction = options.checkAction;
            return _this;
        }
        ...
        Object.defineProperty(RadioEditor.prototype, "checkAction", {
            get: function () {
                return this._checkAction;
            },
            set: function (checkAction) {
        ...
        RadioEditor.prototype.bindGridEvent = function (grid, cellId) {
            var _this = this;
            var _state = grid[RADIO_COLUMN_STATE_ID$1];
            if (!_state) {
        ...
        RadioEditor.prototype._action = function (grid, cell) {
            var _this = this;
            var state = grid[RADIO_COLUMN_STATE_ID$1];
            var range = grid.getCellRange(cell.col, cell.row);
            var cellKey = "".concat(range.start.col, ":").concat(range.start.row);
            if (isReadOnlyRecord(this.readOnly, grid, cell.row) ||
                isDisabledRecord(this.disabled, grid, cell.row) ||
            ...
            grid.doGetCellValue(cell.col, cell.row, function (value) {
                ...
                if (_this._checkAction) {
                    // User behavior
                    var record = grid.getRowRecord(cell.row);
                    _this._checkAction(record, { cell: cell, grid: grid });
                    return;
                }
                if (_this._group) {
                    // Backward compatibility
                    var state_1 = grid[RADIO_COLUMN_STATE_ID$1];
                ...
                var _loop_1 = function (index) {
                    ...
                    var showData = girdRecords.find(function (d) { return d.record === record; });
                    if (showData) {
                        actionCell(grid, cell.col, showData.row, showData.row === recordStartRow);
                    }
                    else {
                        // Hidden record
                        then(dataSource.getField(index, field), function (value) {
                            if (!toBoolean(value)) {
                                return;
                            }
    ...
    function getAllRecordsFromGrid(grid) {
        ...
        for (var targetRow = grid.frozenRowCount; targetRow < rowCount; targetRow += recordRowCount) {
            ...
            result.push({ row: targetRow, record: record });
        }
        return result;
    }
    ...
    var INPUT_CLASSNAME_SDE = "".concat(CLASSNAME_SDE, "__input");
    var HIDDEN_CLASSNAME_SDE = "".concat(CLASSNAME_SDE, "--hidden");
    var SHOWN_CLASSNAME_SDE = "".concat(CLASSNAME_SDE, "--shown");
    ...
    var SmallDialogInputElement = /** @class */ (function () {
        function SmallDialogInputElement() {
            ...
            this._input = this._dialog.querySelector(".".concat(INPUT_CLASSNAME_SDE));
    ...
    var BaseCheckColumn = /** @class */ (function (_super) {
        ...
        BaseCheckColumn.prototype.drawInternal = function (value, context, style, helper, grid, _a) {
            ...
            var record = getRecord();
            var isCustomDraw = customDraw(helper, this.draw, value, context, grid, record);
            if (!isCustomDraw) {
                var col = context.col, row = context.row;
                var range = grid.getCellRange(col, row);
                var cellKey = "".concat(range.start.col, ":").concat(range.start.row);
    ...
    function joinLine(timeline, branchIndex) {
        var reverse = __spreadArray([], timeline, true).reverse();
    ...
    function commitMerge(_a, from, to) {
        ...
        var froms = __spreadArray([], timeline, true);
        ...
        ButtonColumn.prototype.drawInternal = function (value, context, style, helper, grid, _a) {
            ...
            loadIcons(getIcon(), context, helper, function (icons, ctx) {
                if (_this._linkButton) {
                    ...
                    helper.text(value, ctx, {
                        color: active
                            ? buttonBgColor || helper.theme.button.bgColor
                            : color || helper.theme.button.color,
                        font: font,
                        icons: icons,
                        padding: padding,
                        textAlign: textAlign,
    ...
    var CheckColumn = /** @class */ (function (_super) {
        ...
        CheckColumn.prototype.doDrawInternal = function (helper, value, context, record, opt) {
    ...
    var SwitchColumn = /** @class */ (function (_super) {
        ...
        function SwitchColumn(options) {
            if (options === void 0) { options = {}; }
            var _this = _super.call(this, options) || this;
            _this._textOn = options.textOn;
            _this._textOff = options.textOff;
            return _this;
        }
        Object.defineProperty(SwitchColumn.prototype, "textOn", {
            get: function () {
                return this._textOn;
            },
            set: function (value) {
        ...
        Object.defineProperty(SwitchColumn.prototype, "textOff", {
            get: function () {
        ...
        SwitchColumn.prototype.doDrawInternal = function (helper, value, context, record, opt) {
            var textOff = getOrApply(this.textOff, record);
            var textOn = getOrApply(this.textOn, record);
            var options = __assign(__assign({}, opt), { textOn: textOn, textOff: textOff });
    ...
    var IconColumn = /** @class */ (function (_super) {
        ...
        IconColumn.prototype.drawInternal = function (value, context, style, helper, grid, info) {
            ...
            if (!isNaN(num)) {
                var icon_1 = {};
                icons$2.iconPropKeys.forEach(function (k) {
                    icon_1[k] = style[k];
                });
    ...
    function getField(record, field, setPromiseBack) {
        ...
        var fieldResult = applyChainSafe.apply(void 0, __spreadArray([record,
            function (val, name) { return getField(val, name, emptyFn); }], ss, false));
        ...
        if (record) {
            ...
            if (ds._pIdMap[key]) {
                if (!ds._expandMap[key]) {
                    ...
                    (_a = ds._records).splice.apply(_a, __spreadArray([index + 1, 0], _getExpandRecords(ds, record), false));
                }
                else if (all) {
                    _expandAll(ds, record);
                    (_b = ds._records).splice.apply(_b, __spreadArray([index + 1,
                        _getCollapseRecordCount(ds, index)], _getExpandRecords(ds, record), false));
                }
                if (silent === 0) {
     ...
     * columns
     */
    var columns = { action: action$1, type: type$1, style: style$1 };
    ...
    function tokenize(calc) {
        ...
        function parseUnit(num, unit, start) {
            ...
            tokens.push({ value: parseFloat(num), unit: unit, type: TYPE_UNIT });
            return index;
        }
        return tokens;
    }
    ...
    function lex(tokens, calc) {
        ...
        var _loop_1 = function () {
            ...
            if (token.type === TYPE_PAREN && token.value === '(') {
                ...
                var num = token.value, unit = token.unit;
                stack.push({
    ...
    var MAX_SCROLL$2 = browser.heightLimit - 1000;
    var MusselScrollbar = /** @class */ (function () {
        function MusselScrollbar(options) {
            var _this = this;
            if (options === void 0) { options = {}; }
            var _a;
            this._handler = new EventHandler();
            ...
            this._height = 0;
            this._width = 0;
            options.scrollbarVisible = (_a = options.scrollbarVisible) !== null && _a !== void 0 ? _a : 'enter';
            window.mussel.scrollbar.attach(this._scrollable, {
                scrollbarVisible: options.scrollbarVisible === 'scroll'
                    ? 'scrolling'
        ...
        MusselScrollbar.prototype.calcTop = function (top) {
            var relativeTop = top - this.scrollTop;
            return this._scrollable.scrollTop + relativeTop;
        };
        MusselScrollbar.prototype.getElement = function () {
            return this._scrollable;
        };
        MusselScrollbar.prototype.setScrollSize = function (width, height) {
            this._width = width;
            this._height = height;
            this._update();
        };
        Object.defineProperty(MusselScrollbar.prototype, "scrollWidth", {
            get: function () {
                return this._width;
            },
            set: function (width) {
        ...
        Object.defineProperty(MusselScrollbar.prototype, "scrollHeight", {
            get: function () {
                return this._height;
            },
            set: function (height) {
        ...
        Object.defineProperty(MusselScrollbar.prototype, "scrollLeft", {
            get: function () {
        ...
        Object.defineProperty(MusselScrollbar.prototype, "scrollTop", {
            get: function () {
        ...
        MusselScrollbar.prototype.onScroll = function (fn) {
            this._handler.on(this._scrollable, 'scroll', fn);
        };
        MusselScrollbar.prototype.dispose = function () {
            window.mussel.scrollbar.detach(this._scrollable);
            this._handler.dispose();
        };
        MusselScrollbar.prototype.update = function () {
            this._update();
        };
        MusselScrollbar.prototype._update = function () {
            var domHeight;
            if (this._height > MAX_SCROLL$2) {
                var sbSize = style$2.getScrollBarSize();
                var offsetHeight = this._scrollable.offsetHeight;
                var vScrollRange = MAX_SCROLL$2 - offsetHeight + sbSize;
            ...
            this._endPointElement.style.left = "".concat(domWidth.toFixed(), "px");
        };
        return MusselScrollbar;
    }());
    ...
    var Scrollable = /** @class */ (function () {
        ...
        Scrollable.prototype._update = function () {
            ...
            this._endPointElement.style.top = "".concat(top.toFixed(), "px");
            this._endPointElement.style.left = "".concat(left.toFixed(), "px");
            // 不让滚动条位置超出范围
    ...
    var BaseMouseDownMover = /** @class */ (function () {
        ...
        BaseMouseDownMover.prototype.moving = function () {
    ...
    var DrawCellContext = /** @class */ (function () {
        ...
        DrawCellContext.prototype.getRect = function () {
            ...
            return rectFilter
                ? rectFilter(this._getRectInternal(), this._range)
    ...
    var FocusControl = /** @class */ (function (_super) {
        ...
        function FocusControl(grid, parentElement, scrollable) {
            ...
            var lastInputValue;
            var inputClear = function (storeLastInputValue) {
        ...
        FocusControl.prototype.setFocusRect = function (rect) {
            ...
            input.style.top = "".concat((top - style$2.getScrollBarSize()).toFixed(), "px");
            input.style.left = "".concat(rect.left.toFixed(), "px");
            input.style.width = "".concat(rect.width.toFixed(), "px");
            input.style.height = "".concat(rect.height.toFixed(), "px");
        };
    ...
    function _getTargetRowAt(absoluteY) {
        ...
        var findAfter = function (startRow, startBottom) {
            ...
            var rowCount = _this[_$2].rowCount;
    ...
    function _getTargetColAt(absoluteX) {
        var left = 0;
        var colCount = this[_$2].colCount;
    ...
    function _getTargetFrozenRowAt(absoluteY) {
        ...
        var top = this[_$2].scroll.top;
        var rowCount = this[_$2].frozenRowCount;
    ...
    function _getTargetFrozenColAt(absoluteX) {
        ...
        var left = this[_$2].scroll.left;
        var colCount = this[_$2].frozenColCount;
        for (var col = 0; col < colCount; col++) {
            var width = _getColWidth.call(this, col);
            var right = left + width;
            if (right > absoluteX) {
    ...
    function _drawCell(ctx, col, absoluteLeft, width, row, absoluteTop, height, visibleRect, skipAbsoluteTop, skipAbsoluteLeft, drawLayers) {
        ...
        if (drawRect.height > 0 && drawRect.width > 0) {
            ...
            try {
                ...
                var dcContext_1 = new DrawCellContext(col, row, ctx, rect, drawRect, !!cellDrawing, this[_$2].selection, drawLayers);
    ...
    function _drawRow(ctx, initFrozenCol, initCol, drawRight, row, absoluteTop, height, visibleRect, skipAbsoluteTop, drawLayers) {
        ...
        var drawOuter = function (col, absoluteLeft) {
            // 在数据范围之外绘制
            if (col >= colCount - 1 &&
                _this[_$2].canvas.width > absoluteLeft - visibleRect.left) {
                var outerLeft = absoluteLeft - visibleRect.left;
                if (_this.underlayBackgroundColor === 'transparent') {
                    ctx.clearRect(outerLeft, absoluteTop - visibleRect.top, _this[_$2].canvas.width - outerLeft, height);
                }
                else {
                    ctx.save();
                    ctx.beginPath();
                    ctx.fillStyle = _this.underlayBackgroundColor || '#F6F6F6';
                    ctx.rect(outerLeft, absoluteTop - visibleRect.top, _this[_$2].canvas.width - outerLeft, height);
                    ctx.fill();
                    ctx.restore();
                }
            }
        ...
        if (initFrozenCol) {
            ...
            var count = this[_$2].frozenColCount;
    ...
    function _toPxWidth(grid, width) {
        ...
        var w = toPx(width, grid[_$2].calcWidthContext);
    ...
    function _getColWidthDefine(col) {
        var width = this[_$2].colWidthsMap.get(col);
        if (width) {
            return width;
        }
    ...
    function _getColWidthLimits(col) {
        var limit = this[_$2].colWidthsLimit[col];
        if (!limit) {
            return null;
        }
        var result = {};
     ...
     * @returns formula
     */
    function _calcAutoColWidthExpr(shortCircuit) {
        if (shortCircuit === void 0) { shortCircuit = true; }
        var fullWidth = this[_$2].calcWidthContext.full;
        var sumMin = 0;
        var others = [];
        var autoCount = 0;
        var hasLimitsOnAuto = [];
        for (var col = 0; col < this[_$2].colCount; col++) {
        ...
        if (hasLimitsOnAuto.length && others.length) {
            var autoPx_1 = (fullWidth -
                _toPxWidth(this, "calc(".concat(others
                    .map(function (c) { return (typeof c === 'number' ? "".concat(c, "px") : c); })
                    .join(' + '), ")"))) /
                autoCount;
            hasLimitsOnAuto.forEach(function (limits) {
                if (limits.min && autoPx_1 < limits.min) {
                    others.push(limits.minDef);
                    autoCount--;
                }
                else if (limits.max && limits.max < autoPx_1) {
                    others.push(limits.maxDef);
                    autoCount--;
                }
            });
            if (shortCircuit && autoCount <= 0) {
                return "".concat(autoPx_1, "px");
            }
        }
        if (others.length) {
            var strDefs_1 = [];
            ...
            strDefs_1.push("".concat(num_1, "px"));
            return "calc((100% - (".concat(strDefs_1.join(' + '), ")) / ").concat(autoCount, ")");
        }
        else {
    ...
    function _getRowHeight(row) {
        ...
        var height = this[_$2].rowHeightsMap.get(row);
        if (height) {
            return height;
        }
    ...
    function _getRowsHeight(startRow, endRow) {
        ...
        this[_$2].rowHeightsMap.each(startRow, endRow, function (height) {
    ...
    function _getScrollWidth() {
        var w = this._getColsWidth(0, this[_$2].colCount - 1);
    ...
    function _getScrollHeight() {
        var _this = this;
        var internal = this.getScrollHeightInternal(this[_$2].rowCount);
        if (typeof internal === 'number') {
            return Number(internal);
        }
        var h = this.defaultRowHeight * this[_$2].rowCount;
        this[_$2].rowHeightsMap.each(0, this[_$2].rowCount - 1, function (height) {
            h += height - _this.defaultRowHeight;
        });
    ...
    function _onScroll(_e) {
        var lastLeft = this[_$2].scroll.left;
        var lastTop = this[_$2].scroll.top;
        var moveX = this[_$2].scrollable.scrollLeft - lastLeft;
        var moveY = this[_$2].scrollable.scrollTop - lastTop;
        // 保留下一个计算信息
        this[_$2].scroll = {
    ...
    function _bindEvents() {
        var _this = this;
        var _a = this[_$2], handler = _a.handler, element = _a.element, scrollable = _a.scrollable;
        ...
        var canResizeColumn = function (col) {
            var limit = _this[_$2].colWidthsLimit[col];
        ...
        handler.on(element, 'mousedown', function (e) {
            ...
            if (_getResizeSelectionAt.call(_this, abstractPos.x, abstractPos.y)) {
                _this[_$2].selectionResizer.start(e);
            }
            else {
                var resizeCol = _getResizeColAt.call(_this, abstractPos.x, abstractPos.y);
                if (resizeCol >= 0 && canResizeColumn(resizeCol)) {
                    // 改变宽度
                    _this[_$2].columnResizer.start(resizeCol, e);
                }
                else {
                    // 选择
                    _this[_$2].cellSelector.start(e);
                }
            }
        });
        ...
        handler.on(element, 'touchend', function (e) {
            if (longTouchId) {
                clearTimeout(longTouchId);
                _this[_$2].cellSelector.select(e);
                longTouchId = null;
            }
        });
        ...
        handler.on(element, 'click', function (e) {
            if (_this[_$2].columnResizer.lastMoving(e) ||
                _this[_$2].selectionResizer.lastMoving(e) ||
                _this[_$2].cellSelector.lastMoving(e)) {
                return;
            }
        ...
        this[_$2].focusControl.onKeyDown(function (evt) {
            var results = _this.fireListeners(DG_EVENT_TYPE.KEYDOWN, evt);
            if (array.findIndex(results, function (v) { return v === false; }) >= 0) {
                return false;
            }
        });
        this[_$2].selection.listen(DG_EVENT_TYPE.SELECTED_CELL, function (data) {
        ...
        scrollable.onScroll(function (e) {
            ...
            if (t instanceof Element) {
                var isScrollBottom = Math.abs(t.scrollHeight - t.scrollTop - t.clientHeight) <= 1;
                var isScrollRight = Math.abs(t.scrollWidth - t.scrollLeft - t.clientWidth) <= 1;
                _this.fireListeners(DG_EVENT_TYPE.SCROLL, {
                    event: e,
                    scrollPosition: {
                        isTop: t.scrollTop === 0,
                        isLeft: t.scrollLeft === 0,
                        isRight: isScrollRight,
                        isBottom: isScrollBottom,
                    },
                });
            }
        });
        this[_$2].focusControl.onKeyDownMove(function (e) {
            _onKeyDownMove.call(_this, e);
        });
        var getCopyValue = function () {
            var copyValue = '';
            var range = _this[_$2].selection.range;
        ...
        this[_$2].focusControl.onCopy(function (e) {
        ...
        this[_$2].focusControl.onCut(function (e) {
            var copyValue = getCopyValue();
        ...
        this[_$2].focusControl.onPaste(function (e) {
            var value = e.value;
            var event = e.event;
            ...
            if (isDef(pasteValue)) {
                ...
                var _a = _this[_$2].selection.select, col = _a.col, row = _a.row;
        ...
        this[_$2].focusControl.onInput(function (value) {
            var col = _this[_$2].selection.select.col;
            var row = _this[_$2].selection.select.row;
            _this.fireListeners(DG_EVENT_TYPE.INPUT_CELL, { col: col, row: row, value: value });
        });
        this[_$2].focusControl.onDelete(function (event) {
            var _a = _this[_$2].selection.select, col = _a.col, row = _a.row;
            _this.fireListeners(DG_EVENT_TYPE.DELETE_CELL, { col: col, row: row, event: event });
        });
        this[_$2].focusControl.onFocus(function (e) {
            _this.fireListeners(DG_EVENT_TYPE.FOCUS_GRID, e);
            _this[_$2].focusedGrid = true;
            var col = _this[_$2].selection.select.col;
            var row = _this[_$2].selection.select.row;
            _this.invalidateCell(col, row);
        });
        this[_$2].focusControl.onBlur(function (e) {
            _this.fireListeners(DG_EVENT_TYPE.BLUR_GRID, e);
            _this[_$2].focusedGrid = false;
            var col = _this[_$2].selection.select.col;
            var row = _this[_$2].selection.select.row;
            _this.invalidateCell(col, row);
        });
    ...
    var DrawGrid = /** @class */ (function (_super) {
        ...
        function DrawGrid(options) {
            ...
            var _this = _super.call(this) || this;
            grids.push(_this);
            var _d = options.rowCount, rowCount = _d === void 0 ? 10 : _d, _f = options.colCount, colCount = _f === void 0 ? 10 : _f, _g = options.frozenColCount, frozenColCount = _g === void 0 ? 0 : _g, _h = options.frozenRowCount, frozenRowCount = _h === void 0 ? 0 : _h, defaultRowHeight = options.defaultRowHeight, defaultColWidth = options.defaultColWidth, highlightBorderWidth = options.highlightBorderWidth, font = options.font, _j = options.underlayRowCount, underlayRowCount = _j === void 0 ? 0 : _j, _k = options.underlayColCount, underlayColCount = _k === void 0 ? 0 : _k, _l = options.underlayRowHeight, underlayRowHeight = _l === void 0 ? 'auto' : _l, _m = options.underlayColWidth, underlayColWidth = _m === void 0 ? 'auto' : _m, underlayBackgroundColor = options.underlayBackgroundColor, _o = options.borderMode, borderMode = _o === void 0 ? 'none' : _o, _p = options.borderColor, borderColor = _p === void 0 ? '' : _p, _q = options.borderWidth, borderWidth = _q === void 0 ? 0 : _q, keyboardOptions = options.keyboardOptions, scrollbarOptions = options.scrollbarOptions, parentElement = options.parentElement, singleSelection = options.singleSelection, disableColumnResize = options.disableColumnResize;
            var protectedSpace = (_this[_$2] = {});
            ...
            protectedSpace.scrollbarOptions = scrollbarOptions || {};
            protectedSpace.scrollbarOptions.scrollbarVisible =
                (_a = protectedSpace.scrollbarOptions.scrollbarVisible) !== null && _a !== void 0 ? _a : 'enter';
            protectedSpace.scrollable = style$2.hasMusselScrollbar()
                ? new MusselScrollbar(protectedSpace.scrollbarOptions)
            ...
            protectedSpace.keyboardOptions.moveCellOnEnter =
                (_b = protectedSpace.keyboardOptions.moveCellOnEnter) !== null && _b !== void 0 ? _b : true;
            protectedSpace.keyboardOptions.moveCellOnTab =
                (_c = protectedSpace.keyboardOptions.moveCellOnTab) !== null && _c !== void 0 ? _c : true;
        ...
        DrawGrid.prototype.focus = function () {
            var _a = this[_$2].selection.select, col = _a.col, row = _a.row;
        ...
        Object.defineProperty(DrawGrid.prototype, "rowCount", {
            ...
            set: function (rowCount) {
                ...
                if (this[_$2].selection._updateGridRange()) {
                    var _a = this[_$2].selection.focus, col = _a.col, row = _a.row;
        ...
        Object.defineProperty(DrawGrid.prototype, "scrollbarOptions", {
            get: function () {
                var _a;
                return (_a = this[_$2].scrollbarOptions) !== null && _a !== void 0 ? _a : null;
            },
            enumerable: false,
            configurable: true
        });
        ...
        DrawGrid.prototype.configure = function (name, value) {
            var cfg = this[_$2].config || (this[_$2].config = {});
            if (isDef(value)) {
                cfg[name] = value;
            }
            return cfg[name];
        ...
        DrawGrid.prototype.updateSize = function () {
            ...
            if (!width) {
                ...
                if (parent_1 !== null) {
                    width = parent_1.offsetWidth - style$2.getScrollBarSize();
                }
            }
            ...
            if (!height) {
                ...
                if (parent_2 !== null) {
                    height = parent_2.offsetHeight - style$2.getScrollBarSize();
                }
            }
            ...
            var sel = this[_$2].selection.select;
        ...
        DrawGrid.prototype.updateScroll = function () {
            ...
            var scrollable = this[_$2].scrollable;
        ...
        DrawGrid.prototype.getMaxColWidth = function (col) {
            var obj = this[_$2].colWidthsLimit[col];
        ...
        DrawGrid.prototype.setMaxColWidth = function (col, maxWidth) {
            var obj = this[_$2].colWidthsLimit[col] || (this[_$2].colWidthsLimit[col] = {});
            obj.max = maxWidth;
        };
        /**
        ...
        DrawGrid.prototype.getCellsRect = function (startCol, startRow, endCol, endRow) {
            ...
            if (isFrozenStartCell && isFrozenStartCell.col) {
                var scrollLeft = this[_$2].scroll.left;
            ...
            if (isFrozenStartCell && isFrozenStartCell.row) {
                var scrollTop = this[_$2].scroll.top;
        ...
        DrawGrid.prototype.isFrozenCell = function (col, row) {
            var _a = this[_$2], frozenRowCount = _a.frozenRowCount, frozenColCount = _a.frozenColCount;
        ...
        DrawGrid.prototype.setFocusCursor = function (col, row) {
            var focusControl = this[_$2].focusControl;
        ...
        DrawGrid.prototype._updatedSelection = function () {
            var focusControl = this[_$2].focusControl;
            var _a = this[_$2].selection.select, selCol = _a.col, selRow = _a.row;
        ...
        DrawGrid.prototype.invalidateGridRect = function (startCol, startRow, endCol, endRow) {
            ...
            if (invalidateTarget) {
                var _a = this[_$2], frozenColCount = _a.frozenColCount, frozenRowCount = _a.frozenRowCount;
        ...
        DrawGrid.prototype.addDisposable = function (disposable) {
            ...
            var disposables = (this[_$2].disposables = this[_$2].disposables || []);
        ...
        DrawGrid.prototype.dispose = function () {
            _super.prototype.dispose.call(this);
            var index = grids.indexOf(this);
            if (index >= 0) {
                grids.splice(index, 1);
            }
            var protectedSpace = this[_$2];
        ...
        DrawGrid.prototype._isResizerMoving = function () {
            return (this[_$2].columnResizer.moving() ||
                this[_$2].selectionResizer.moving() ||
                this[_$2].cellSelector.moving());
        };
        DrawGrid.prototype._getMouseAbstractPoint = function (evt) {
            ...
            var rect = this[_$2].canvas.getBoundingClientRect();
            ...
            var x = clientX - rect.left + this[_$2].scroll.left;
            var y = clientY - rect.top + this[_$2].scroll.top;
            return { x: x, y: y };
        };
        ...
        DrawGrid.prototype._getColsWidth = function (startCol, endCol) {
            ...
            this[_$2].colWidthsMap.each(startCol, endCol, function (width, col) {
                w +=
        ...
        DrawGrid.prototype._adjustColWidth = function (col, orgWidth) {
            var offset = this[_$2].colWidthsOffset[col] || 0;
            var limits = _getColWidthLimits.call(this, col);
        ...
        DrawGrid.prototype._getVisibleRect = function () {
            var left = this[_$2].scroll.left;
            var top = this[_$2].scroll.top;
            var width = this[_$2].canvas.width;
            var height = this[_$2].canvas.height;
        ...
        DrawGrid.prototype._invalidateRect = function (drawRect) {
            ...
            if (ctx) {
                ...
                var rowCount_1 = this[_$2].rowCount;
                ...
                var drawGridBorder = function () {
                    ...
                    if (isGrid || isContent) {
                        var width = _this[_$2].canvas.width;
                        var height = _this[_$2].canvas.height;
                        if (isContent) {
                            var w = _this._getColsWidth(0, _this[_$2].colCount - 1) - visibleRect_1.left;
                            var h = _getRowsHeight.call(_this, 0, rowCount_1 - 1) - visibleRect_1.top;
                            width = Math.min(_this[_$2].canvas.width, w);
                            height = Math.min(_this[_$2].canvas.height, h);
                        }
                        ctx.save();
                        try {
                            ctx.beginPath();
                ...
                var drawOuter = function (row, absoluteTop) {
                    // 在数据范围之外绘制
                    if (row >= rowCount_1 - 1 &&
                        _this[_$2].canvas.height > absoluteTop - visibleRect_1.top) {
                        var outerTop = absoluteTop - visibleRect_1.top;
                        if (_this.underlayBackgroundColor === 'transparent') {
                            ctx.clearRect(0, outerTop, _this[_$2].canvas.width, _this[_$2].canvas.height - outerTop);
                        }
                        else {
                            ctx.save();
                            ctx.beginPath();
                            ctx.fillStyle = _this.underlayBackgroundColor || '#F6F6F6';
                            ctx.rect(0, outerTop, _this[_$2].canvas.width, _this[_$2].canvas.height - outerTop);
                            ctx.fill();
                            ctx.restore();
                        }
                    }
                ...
                if (initFrozenRow) {
                    ...
                    var count = this[_$2].frozenRowCount;
        ...
        DrawGrid.prototype._clearColumnsWidth = function () {
            this[_$2].colWidthsMap = new NumberMap();
            this[_$2].colWidthsOffset = {};
            this[_$2].colWidthsLimit = {};
        };
        DrawGrid.prototype.fireListeners = function (type) {
            ...
            return _super.prototype.fireListeners.apply(this, __spreadArray([type], event, false));
        };
        return DrawGrid;
    }(EventTarget));
            ...
            var _loop_1 = function (k) {
                if (FilterDataSource.EVENT_TYPE.hasOwnProperty(k)) {
                    ...
                    handler.on(dataSource, type_1, function () {
                        ...
                        return _this.fireListeners.apply(_this, __spreadArray([type_1], args, false));
                    });
                }
            };
    ...
    var scaleNum = function (number, position) {
        if (number === void 0) { number = 0; }
        if (position === void 0) { position = 0; }
        var num = Number(number);
        var posNum = Number(position);
        ...
        if (posNum > 0) {
            ...
            var zeros = Math.abs(posNum) - intLen;
            while (zeros > 0) {
                zeros -= 1;
                parts.unshift('0');
            }
    ...
    var DEFAULT_TOTAL_CAPTION = '小计';
    var PIVOT_DATA_SOURCE_EVENT_TYPE = __assign(__assign({}, DataSource.EVENT_TYPE), { REFRESH_HEADER: 'refresh_header' });
    var PIVOT_DATA_SOURCE_AGGREGATE_TYPE = {
        COUNT: 'count',
        SUM: 'sum',
        AVG: 'avg',
        MAX: 'max',
    ...
    var PIVOT_DATA_SOURCE_TOTAL_POSITION = {
        NONE: 'none',
        BEFORE: 'before',
        AFTER: 'after',
    };
    var PIVOT_DATA_SOURCE_DIM_SORT = {
        NONE: 'none',
        ASC: 'asc',
        DESC: 'desc',
    };
    function _getPivotRecordKey(record, dimensions, distinctKeys) {
        var keys = [];
        for (var dimIndex = 0; dimIndex < dimensions.length; dimIndex++) {
            var value = JSON.stringify(record[dimensions[dimIndex].field]) || '';
            distinctKeys[dimIndex] = distinctKeys[dimIndex] || {};
            distinctKeys[dimIndex][value] = true;
            keys.push(value);
        }
        return keys.join('|');
    }
    function _forEachSummaries(summaries, callback) {
        for (var summaryIndex = 0; summaryIndex < summaries.length; summaryIndex++) {
            var summary = summaries[summaryIndex];
            callback(summaryIndex, summary);
        }
    }
    function _genHeaderTotal(colDimensions, summaries, fieldMap, header, alwaysShowSummary, level, prefixField, prefixKey) {
        var _a;
        if (level === void 0) { level = 0; }
        if (prefixField === void 0) { prefixField = 'c'; }
        if (prefixKey === void 0) { prefixKey = ''; }
        var colDimension = colDimensions[level];
        var parentFieldInfo = (fieldMap[prefixKey] = fieldMap[prefixKey] || {});
        var totalOptions = {
            caption: (_a = colDimension.totalCaption) !== null && _a !== void 0 ? _a : DEFAULT_TOTAL_CAPTION,
            rowSpan: colDimensions.length - level,
            colSpan: summaries.length > 0 ? summaries.length : 1,
        };
        if (summaries.length <= 1 && !alwaysShowSummary) {
            var fieldName = prefixField + '_t';
            var columnDef = totalOptions;
            columnDef.field = fieldName;
            _assignColDimColumnDefine(columnDef, summaries[0]);
            header.push(columnDef);
            parentFieldInfo[0] = fieldName;
        }
        else {
            var columnDefs_1 = [];
            _forEachSummaries(summaries, function (summaryIndex, summary) {
                var fieldName = prefixField + '_t_s_' + summaryIndex;
                columnDefs_1.push(_assignColDimColumnDefine({
                    field: fieldName,
                }, summary));
                parentFieldInfo[summaryIndex] = fieldName;
            });
            var groupHeaderDef = totalOptions;
            groupHeaderDef.columns = columnDefs_1;
            _assignColDimGroupDefine(groupHeaderDef, colDimension);
            header.push(groupHeaderDef);
        }
    }
    function _genHeader(colDimensions, colDistinctMap, summaries, fieldMap, alwaysShowSummary, level, prefixField, prefixKey) {
        var _a;
        if (level === void 0) { level = 0; }
        if (prefixField === void 0) { prefixField = 'c'; }
        if (prefixKey === void 0) { prefixKey = ''; }
        var header = [];
        if (colDimensions && colDimensions.length > 0) {
            var colDimension = colDimensions[level];
            if (colDimension.totalPosition !== PIVOT_DATA_SOURCE_TOTAL_POSITION.NONE &&
                colDimension.totalPosition === PIVOT_DATA_SOURCE_TOTAL_POSITION.BEFORE) {
                _genHeaderTotal(colDimensions, summaries, fieldMap, header, alwaysShowSummary, level, prefixField, prefixKey);
            }
            var distinctValues = colDistinctMap[level];
            var _loop_1 = function (i) {
                var distinctValue = distinctValues[i];
                var field = prefixField + '_' + i;
                var key = prefixKey ? prefixKey + '|' + distinctValue : distinctValue;
                var caption = JSON.parse(distinctValue);
                if (colDimension.dimValueMap) {
                    caption = (_a = colDimension.dimValueMap[caption]) !== null && _a !== void 0 ? _a : caption;
                }
                var options = {
                    caption: caption,
                };
                if (level === colDimensions.length - 1) {
                    var fieldInfo_1 = (fieldMap[key] = fieldMap[key] || {});
                    if (summaries.length <= 1 && !alwaysShowSummary) {
                        fieldInfo_1[0] = field;
                        var columnDef = options;
                        ...
                        var columnDefs_2 = [];
                        _forEachSummaries(summaries, function (summaryIndex, summary) {
                            var fieldName = field + '_s_' + summaryIndex;
                            columnDefs_2.push(_assignColDimColumnDefine({
                                field: fieldName,
                            }, summary));
                            fieldInfo_1[summaryIndex] = fieldName;
                        });
                        var groupHeaderDef = options;
                        groupHeaderDef.columns = columnDefs_2;
                        _assignColDimGroupDefine(groupHeaderDef, colDimension);
                    }
                }
                else {
                    var groupHeaderDef = options;
                    groupHeaderDef.columns = _genHeader(colDimensions, colDistinctMap, summaries, fieldMap, alwaysShowSummary, level + 1, field, key);
                    _assignColDimGroupDefine(groupHeaderDef, colDimension);
                }
                header.push(options);
            };
            ...
            if (colDimension.totalPosition !== PIVOT_DATA_SOURCE_TOTAL_POSITION.NONE &&
                colDimension.totalPosition === PIVOT_DATA_SOURCE_TOTAL_POSITION.AFTER) {
                _genHeaderTotal(colDimensions, summaries, fieldMap, header, alwaysShowSummary, level, prefixField, prefixKey);
            }
        }
        else if (summaries && summaries.length > 0) {
            var rootFieldInfo_1 = (fieldMap[''] = fieldMap[''] || {});
            _forEachSummaries(summaries, function (summaryIndex, summary) {
                var fieldName = 's_' + summaryIndex;
                header.push(_assignColDimColumnDefine({
                    field: fieldName,
                }, summary));
                rootFieldInfo_1[summaryIndex] = fieldName;
            });
        }
        return header;
    }
    function _deleteEmptyHeader(header, emptyFieldMap) {
        for (var i = header.length - 1; i >= 0; i--) {
            var column = header[i];
            var columns = column.columns;
            if (columns) {
                _deleteEmptyHeader(columns, emptyFieldMap);
                if (columns.length === 0) {
                    header.splice(i, 1);
                }
            }
                ...
                if (emptyFieldMap[field] === true) {
                    header.splice(i, 1);
                }
            }
        }
    }
    function _forEachParentKey(dimensions, dimValues, callback) {
        ...
        for (var dimIndex = 0; dimIndex < dimensions.length; dimIndex++) {
            ...
            parentKey += JSON.stringify(dimValues[dimIndex]);
        }
    }
    function _forEachDim(dimensions, distinctMap, callback, totalCallback, level, prefixKey, dimValues) {
        if (level === void 0) { level = 0; }
        if (prefixKey === void 0) { prefixKey = ''; }
        if (dimValues === void 0) { dimValues = {}; }
        if (dimensions && dimensions.length > 0) {
            var dim = dimensions[level];
            if (dim) {
                var distinctValues = distinctMap[level];
                if (totalCallback &&
                    dim.totalPosition !== PIVOT_DATA_SOURCE_TOTAL_POSITION.NONE &&
                    dim.totalPosition === PIVOT_DATA_SOURCE_TOTAL_POSITION.BEFORE) {
                    totalCallback(level, prefixKey, dimValues);
                }
                for (var _i = 0, distinctValues_1 = distinctValues; _i < distinctValues_1.length; _i++) {
                    var distinctValue = distinctValues_1[_i];
                    var key = prefixKey ? prefixKey + '|' + distinctValue : distinctValue;
                    dimValues[level] = JSON.parse(distinctValue);
                    if (level === dimensions.length - 1) {
                        callback(key, dimValues);
                    }
                    else {
                        _forEachDim(dimensions, distinctMap, callback, totalCallback, level + 1, key, dimValues);
                    }
                }
                if (totalCallback &&
                    dim.totalPosition !== PIVOT_DATA_SOURCE_TOTAL_POSITION.NONE &&
                    dim.totalPosition === PIVOT_DATA_SOURCE_TOTAL_POSITION.AFTER) {
                    totalCallback(level, prefixKey, dimValues);
                }
            }
        }
    ...
    function _cellRangeMergeRow(rangeMap, startCol, startRow, records, rowDimCount, sameCount, endIndex, level) {
        // 合并行维单元格
        if (sameCount > 1) {
            var col = startCol + level;
            var startIndex = endIndex + 1 - sameCount;
            var range = {
                start: { col: col, row: startRow + startIndex },
                end: { col: col, row: startRow + endIndex },
            };
            for (var i = startIndex; i <= endIndex; i++) {
                rangeMap["".concat(col, "|").concat(startRow + i)] = range;
            }
            _getCellRangeMap(rangeMap, startCol, startRow, records, rowDimCount, startIndex, endIndex, level + 1);
        }
    }
    function _getCellRangeMap(rangeMap, startCol, startRow, records, rowDimCount, fromIndex, toIndex, level) {
        if (level === void 0) { level = 0; }
        // 合并行维单元格
        if (level < rowDimCount) {
            var value = void 0;
            var sameCount = 0;
            for (var index = fromIndex; index <= toIndex; index++) {
                var record = records[index];
                var totalLevel = Number(record['_total_level']);
                var isTotal = totalLevel >= 0 && totalLevel <= level;
                if (isTotal) {
                    _cellRangeMergeRow(rangeMap, startCol, startRow, records, rowDimCount, sameCount, index - 1, level);
                    if (rowDimCount - 1 - totalLevel > 0) {
                        var range = {
                            start: { col: startCol + totalLevel, row: startRow + index },
                            end: { col: startCol + rowDimCount - 1, row: startRow + index },
                        };
                        for (var i = totalLevel; i <= rowDimCount - 1; i++) {
                            rangeMap["".concat(startCol + i, "|").concat(startRow + index)] = range;
                        }
                    }
                    value = undefined;
                    sameCount = 0;
            ...
            _cellRangeMergeRow(rangeMap, startCol, startRow, records, rowDimCount, sameCount, toIndex, level);
        }
    }
    function _decodeKeys(keys) {
        var r = [];
    ...
    function _distinctSort(a, b) {
        if (typeof a === 'number' && typeof b === 'number') {
            ...
            return (a === 0 ? '0' : a || '')
                .toLowerCase()
                .localeCompare((b === 0 ? '0' : b || '').toLowerCase());
        }
    }
    function _sortDistinctKeys(distinctKeysMap, dimensions) {
        var distinctMap = {};
        for (var index in distinctKeysMap) {
            var sort = dimensions[index].sort;
            var keys = Object.keys(distinctKeysMap[index]);
            if (sort === 'asc') {
                keys = _encodeKeys(_decodeKeys(keys).sort(function (a, b) {
                    return _distinctSort(a, b);
                }));
            }
            else if (sort === 'desc') {
                keys = _encodeKeys(_decodeKeys(keys).sort(function (a, b) {
                    return _distinctSort(b, a);
                }));
            }
            else if (typeof sort === 'function') {
                keys = _encodeKeys(_decodeKeys(keys).sort(sort));
            }
            distinctMap[index] = keys;
        }
        return distinctMap;
    }
    function _assignRowDimColumnDefine(columnDef, rowDim) {
        var _a, _b;
        columnDef.caption = (_b = (_a = rowDim.caption) !== null && _a !== void 0 ? _a : columnDef.caption) !== null && _b !== void 0 ? _b : rowDim.field;
        columnDef.width = rowDim.width;
        columnDef.maxWidth = rowDim.maxWidth;
        columnDef.minWidth = rowDim.minWidth;
        columnDef.disableResize = rowDim.disableResize;
        columnDef.style = rowDim.style;
        columnDef.headerStyle = rowDim.headerStyle;
        columnDef.colSpan = rowDim.colSpan;
        columnDef.rowSpan = rowDim.rowSpan;
        columnDef.columnType = new Column({
            convert: (function (value, displayValue) {
                var _a;
                return (_a = (rowDim.dimValueMap && rowDim.dimValueMap[value])) !== null && _a !== void 0 ? _a : displayValue;
            }),
        });
        return columnDef;
    }
    function _assignColDimColumnDefine(columnDef, summary) {
        var _a, _b;
        columnDef.caption = (_b = (_a = summary.caption) !== null && _a !== void 0 ? _a : columnDef.caption) !== null && _b !== void 0 ? _b : summary.field;
        columnDef.width = summary.width;
        columnDef.maxWidth = summary.maxWidth;
        columnDef.minWidth = summary.minWidth;
        columnDef.disableResize = summary.disableResize;
        columnDef.style = summary.style;
        columnDef.headerStyle = summary.headerStyle;
        columnDef.colSpan = summary.colSpan;
        columnDef.rowSpan = summary.rowSpan;
        return columnDef;
    }
    function _assignColDimGroupDefine(groupDef, colDim) {
        groupDef.headerStyle = colDim.headerStyle;
        return groupDef;
    }
    /**
    ...
    var PivotDataSource = /** @class */ (function (_super) {
        ...
        Object.defineProperty(PivotDataSource, "EVENT_TYPE", {
            get: function () {
                return PIVOT_DATA_SOURCE_EVENT_TYPE;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource, "AGGREGATE_TYPE", {
            get: function () {
                return PIVOT_DATA_SOURCE_AGGREGATE_TYPE;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource, "TOTAL_POSITION", {
            get: function () {
                return PIVOT_DATA_SOURCE_TOTAL_POSITION;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource, "DIM_SORT", {
            get: function () {
                return PIVOT_DATA_SOURCE_DIM_SORT;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource.prototype, "source", {
            get: function () {
                return this._dataSource.source;
            },
            enumerable: false,
        ...
        Object.defineProperty(PivotDataSource.prototype, "dataSource", {
            get: function () {
                return this._dataSource;
            },
            enumerable: false,
        ...
        Object.defineProperty(PivotDataSource.prototype, "header", {
            get: function () {
                return this._header;
            },
            enumerable: false,
        ...
        Object.defineProperty(PivotDataSource.prototype, "rowDimensions", {
            get: function () {
                return this._options.rowDimensions;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource.prototype, "colDimensions", {
            get: function () {
                return this._options.colDimensions;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource.prototype, "summaries", {
            get: function () {
                return this._options.summaries;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource.prototype, "showEmptyRow", {
            get: function () {
                return !!this._options.showEmptyRow;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource.prototype, "showEmptyCol", {
            get: function () {
                return !!this._options.showEmptyCol;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PivotDataSource.prototype, "alwaysShowSummary", {
            get: function () {
                return !!this._options.alwaysShowSummary;
            },
            enumerable: false,
            configurable: true
        });
        PivotDataSource.prototype.getCellRangeMap = function (startCol, startRow) {
            var range = {};
            _getCellRangeMap(range, startCol, startRow, this._records, (this.rowDimensions || []).length, 0, this._records.length - 1);
            return range;
        };
        PivotDataSource.prototype.getOriginal = function (index) {
            return this._records[index];
        };
        PivotDataSource.prototype.refreshInternal = function () {
            ...
            var colDimensions = this.colDimensions || [];
            var summaries = this.summaries || [];
            // 聚合记录
            for (var i = 0; i < this._dataSource.length; i++) {
                var record = this._dataSource.get(i);
                var rowKey = _getPivotRecordKey(record, rowDimensions, rowDistinctKeys);
                var colKey = _getPivotRecordKey(record, colDimensions, colDistinctKeys);
                keyRecordsMap[rowKey] = keyRecordsMap[rowKey] || {};
                keyRecordsMap[rowKey][colKey] = keyRecordsMap[rowKey][colKey] || [];
                keyRecordsMap[rowKey][colKey].push(record);
            }
            // 获取维度值
            var rowDistinctMap = _sortDistinctKeys(rowDistinctKeys, rowDimensions);
            var colDistinctMap = _sortDistinctKeys(colDistinctKeys, colDimensions);
            // 聚合值
            var keyValueMap = {};
            for (var rowKey in keyRecordsMap) {
                var rowValueMap = (keyValueMap[rowKey] = keyValueMap[rowKey] || {});
                var _loop_2 = function (colKey) {
                    var colValueMap = (rowValueMap[colKey] = rowValueMap[colKey] || {});
                    var records_1 = keyRecordsMap[rowKey][colKey];
                    _forEachSummaries(summaries, function (summaryIndex, summary) {
                        var value;
                        if (summary.aggregate === PIVOT_DATA_SOURCE_AGGREGATE_TYPE.COUNT) {
                            value = records_1.length;
                        }
                        else if (records_1.length > 0) {
                            for (var _i = 0, records_2 = records_1; _i < records_2.length; _i++) {
                                var record = records_2[_i];
                                var v = record[summary.field];
                                if (value === undefined) {
                                    value = v;
                                }
                                else if (summary.aggregate === PIVOT_DATA_SOURCE_AGGREGATE_TYPE.MIN) {
                                    value = Math.min(value, v);
                                }
                                else if (summary.aggregate === PIVOT_DATA_SOURCE_AGGREGATE_TYPE.MAX) {
                                    value = Math.max(value, v);
                                }
                                else {
                                    // if (column.aggregate === PIVOT_DATA_SOURCE_AGGREGATE_TYPE.SUM || column.aggregate === PIVOT_DATA_SOURCE_AGGREGATE_TYPE.AVG) {
                                    value = add$1(value, v);
                                }
                            }
                            if (summary.aggregate === PIVOT_DATA_SOURCE_AGGREGATE_TYPE.AVG) {
                                value = div(value, records_1.length);
                            }
                        }
                        colValueMap[summaryIndex] = value;
                    });
                };
                for (var colKey in keyRecordsMap[rowKey]) {
                    _loop_2(colKey);
                }
            }
            // 计算列头
            this._header = [];
            for (var rowDimIndex = 0; rowDimIndex < rowDimensions.length; rowDimIndex++) {
                var rowDim = rowDimensions[rowDimIndex];
                this._header.push(_assignRowDimColumnDefine({
                    field: ('r_' + rowDimIndex),
                }, rowDim));
            }
            var fieldMap = {};
            (_a = this._header).push.apply(_a, _genHeader(colDimensions, colDistinctMap, summaries, fieldMap, this.alwaysShowSummary));
            // 初始化空字段标记
            var emptyFieldMap = {};
            _forEachDim(colDimensions, colDistinctMap, function (colKey, colDimValues) {
                _forEachSummaries(summaries, function (summaryIndex) {
                    var field = fieldMap[colKey][summaryIndex];
                    emptyFieldMap[field] = true;
                    _forEachParentKey(colDimensions, colDimValues, function (parentKey) {
                        if (fieldMap[parentKey]) {
                            var totalField = fieldMap[parentKey][summaryIndex];
                            emptyFieldMap[totalField] = true;
                        }
                    });
                });
            });
            // 计算列维记录
            var recordMap = {};
            _forEachDim(rowDimensions, rowDistinctMap, function (rowKey, rowDimValues) {
                var record = {};
                var isEmptyRow = true;
                _forEachDim(colDimensions, colDistinctMap, function (colKey, colDimValues) {
                    _forEachSummaries(summaries, function (summaryIndex) {
                        var field = fieldMap[colKey][summaryIndex];
                        var value = keyValueMap[rowKey] &&
                            keyValueMap[rowKey][colKey] &&
                            keyValueMap[rowKey][colKey][summaryIndex];
                        if (value !== undefined) {
                            record[field] = value;
                            isEmptyRow = false;
                            emptyFieldMap[field] = false;
                            _forEachParentKey(colDimensions, colDimValues, function (parentKey) {
                                if (fieldMap[parentKey]) {
                                    var totalField = fieldMap[parentKey][summaryIndex];
                                    record[totalField] = add$1(record[totalField], record[field]);
                                    emptyFieldMap[totalField] = false;
                                }
                            });
                        }
                    });
                });
                if (!isEmptyRow || _this.showEmptyRow) {
                    recordMap[rowKey] = record;
                    _forEachParentKey(rowDimensions, rowDimValues, function (parentKey) {
                        var totalRecord = (recordMap[parentKey] =
                            recordMap[parentKey] || {});
                        for (var field in record) {
                            totalRecord[field] = add$1(totalRecord[field], record[field]);
                        }
                    });
                }
            });
            // 删除空列
            if (!this.showEmptyCol) {
                _deleteEmptyHeader(this._header, emptyFieldMap);
            }
            // 计算行维记录
            var records = [];
            _forEachDim(rowDimensions, rowDistinctMap, function (rowKey, dimValues) {
                var record = recordMap[rowKey];
                if (record) {
                    for (var rowDimIndex = 0; rowDimIndex < rowDimensions.length; rowDimIndex++) {
                        record['r_' + rowDimIndex] = dimValues[rowDimIndex];
                    }
                    record['_total_level'] = -1;
                    records.push(record);
                }
            }, function (totalLevel, totalKey, totalValues) {
                var _a;
                var record = recordMap[totalKey];
                if (record) {
                    for (var rowDimIndex = 0; rowDimIndex < rowDimensions.length; rowDimIndex++) {
                        record['r_' + rowDimIndex] =
                            rowDimIndex < totalLevel
                                ? totalValues[rowDimIndex]
                                : (_a = rowDimensions[totalLevel].totalCaption) !== null && _a !== void 0 ? _a : DEFAULT_TOTAL_CAPTION;
                    }
                    record['_total_level'] = totalLevel;
                    records.push(record);
                }
            });
            this._records = records; // 显示记录列表
            this.fireListeners(PIVOT_DATA_SOURCE_EVENT_TYPE.REFRESH_HEADER);
            this.length = this._records.length;
            // const end = new Date()
    ...
    function bindCellClickAction(grid, cellId, _a) {
        ...
        return [
            // click
            grid.listen(DG_EVENT_TYPE.CLICK_CELL, function (e) {
                if (!isTarget(e.col, e.row) || grid._isResizerMoving()) {
                    return;
                }
                action({
                    col: e.col,
    ...
    var BaseCheckAction = /** @class */ (function (_super) {
        ...
        BaseCheckAction.prototype.bindGridEvent = function (grid, cellId) {
            ...
            return __spreadArray(__spreadArray([], bindCellClickAction(grid, cellId, {
                action: action,
                mouseOver: function (e) {
                    var range = grid.getCellRange(e.col, e.row);
                    if (isHeaderDisabledCell(_this.disabled, grid, {
            ...
            }), true), bindCellKeyAction(grid, cellId, {
                action: action,
                acceptKeys: [KEY_ENTER, KEY_SPACE],
            }), true);
        };
    ...
    var HEADER_STATE_ID$1 = getHeaderStateId();
    var HeaderAction = /** @class */ (function (_super) {
        ...
        HeaderAction.prototype.clone = function () {
            return new HeaderAction(this);
        };
        Object.defineProperty(HeaderAction.prototype, "action", {
            get: function () {
                return this._action;
            },
            set: function (action) {
        ...
        HeaderAction.prototype.bindGridEvent = function (grid, cellId) {
            var _this = this;
            var state = this.getState(grid);
            var action = function (cell) {
                if (!_this._action || isHeaderDisabledCell(_this.disabled, grid, cell)) {
                    return;
                }
                if (state.mouseActive) {
                    if (_this._action) {
            ...
            return __spreadArray([], bindCellClickAction(grid, cellId, {
                action: action,
                mouseOut: mouseOut,
                mouseMove: mouseMove,
                mouseOver: mouseMove,
        ...
        HeaderAction.prototype.getState = function (grid) {
            if (!grid[HEADER_STATE_ID$1]) {
                obj.setReadonly(grid, HEADER_STATE_ID$1, {});
            }
            return grid[HEADER_STATE_ID$1];
        };
        return HeaderAction;
    }(BaseAction));
    ...
    var SortHeaderAction = /** @class */ (function (_super) {
        ...
        function SortHeaderAction(options) {
            if (options === void 0) { options = {}; }
            var _a;
            var _this = _super.call(this, options) || this;
            _this._sort = (_a = options.sort) !== null && _a !== void 0 ? _a : true;
            return _this;
        }
    ...
    var BaseHeader = /** @class */ (function () {
        ...
        Object.defineProperty(BaseHeader.prototype, "draw", {
            get: function () {
                return this._draw;
            },
            enumerable: false,
        ...
        BaseHeader.prototype.onDrawCell = function (cellValue, info, context, grid) {
            var style = info.style, drawCellBase = info.drawCellBase, drawCellBorder = info.drawCellBorder;
            var helper = grid.getGridCanvasHelper();
            drawCellBase();
            // 文字
        ...
        BaseHeader.prototype.convertInternal = function (value) {
            ...
            return isDef(value) ? "".concat(value) : '';
        };
    ...
    function getElementOffset(curEle) {
        var x = curEle.getBoundingClientRect().left + document.documentElement.scrollLeft;
        var y = curEle.getBoundingClientRect().top + document.documentElement.scrollTop;
        return {
            x: x,
            y: y,
        };
    ...
    function showHeaderTooltip(grid, point, tooltip) {
        ...
        var p = getElementOffset(grid.getElement());
    ...
    var headerUtils = {
        ...
        getIconPadding: function (context, helper, style) {
            var font = style.font;
            var padding = style.padding;
            var basePadding = helper.toBoxPixelArray(padding || 0, context, font);
            var textPadding = basePadding.slice(0);
        ...
        drawIconTooltipButton: function (grid, context, stateId, helper, style, tooltip) {
            var textBaseline = style.textBaseline;
            var font = style.font;
            var padding = style.padding;
            var color = style.color;
            ...
            if (state) {
                var rect = context.getRect();
                var btnWidth = 16;
                rect = new Rect(rect.left + rect.width - btnWidth - iconPadding[1] - 4, rect.top + (rect.height - btnWidth) / 2, btnWidth, btnWidth);
                if (state.mouseActiveCell &&
                    cellInRange(context.range, state.mouseActiveCell.col, state.mouseActiveCell.row)) {
            ...
            if (!active) {
                var l = 0;
                for (var key in activeHeaderTooltip) {
        ...
        customDraw: function (helper, draw, value, context, grid) {
            var b = false;
            if (draw) {
                var rect = context.getRect();
                var row = context.row;
        ...
        drawActionButton: function (grid, context, stateId, helper, style) {
            return drawUtils.drawActionButton(grid, context, stateId, helper, style);
        },
    };
    ...
    var BaseCheckHeader = /** @class */ (function (_super) {
        ...
        BaseCheckHeader.prototype.drawInternal = function (value, context, style, helper, grid, _a) {
            ...
            var elapsed = state === null || state === void 0 ? void 0 : state.elapsed[cellKey];
            var checked = grid.getHeaderValue(range.start.col, range.start.row);
            var isCustomDraw = headerUtils.customDraw(helper, this.draw, !!checked, context, grid);
            if (!isCustomDraw) {
                var opt = {
                    textAlign: textAlign,
                    textBaseline: textBaseline,
    ...
    var HEADER_STATE_ID = getHeaderStateId();
    var HEADER_ICON_TOOLTIP_STATE_ID = getHeaderIconTooltipStateId();
    var Header = /** @class */ (function (_super) {
        ...
        Header.prototype.drawInternal = function (value, context, style, helper, grid, _a) {
            var _this = this;
            var drawCellBase = _a.drawCellBase, getHeaderIcon = _a.getHeaderIcon, getHeaderIconTooltip = _a.getHeaderIconTooltip;
            ...
            var iconTooltip = getHeaderIconTooltip();
            var v = isDef(value) ? value + '' : '';
            var multiLines = v
                .replace(/\r?\n/g, '\n')
                .replace(/\r/g, '\n')
            ...
            headerUtils.loadIcons(getHeaderIcon(), context, helper, function (icons, ctx) {
                var isCustomDraw = headerUtils.customDraw(helper, _this.draw, value, context, grid);
                var hasBtn = headerUtils.drawActionButton(grid, context, HEADER_STATE_ID, helper, style);
                if (!isCustomDraw) {
                    var newPadding = iconTooltip || hasBtn
                        ? headerUtils.getIconPadding(context, helper, style)
                        : padding;
    ...
    var SortHeader = /** @class */ (function (_super) {
        ...
        SortHeader.prototype.drawInternal = function (value, context, style, helper, grid, _a) {
            ...
            var isCustomDraw = headerUtils.customDraw(helper, this.draw, multiLines, context, grid);
            if (!isCustomDraw) {
                if (multiLines.length > 1) {
    ...
    var SwitchHeader = /** @class */ (function (_super) {
        ...
        Object.defineProperty(SwitchHeader.prototype, "textOn", {
            get: function () {
                return this._textOn;
            },
            set: function (value) {
        ...
        Object.defineProperty(SwitchHeader.prototype, "textOff", {
            get: function () {
                return this._textOff;
            },
            set: function (value) {
        ...
        SwitchHeader.prototype.getInlineCheck = function (helper, checked, context, opt) {
            var options = __assign(__assign({}, opt), { textOn: this.textOn, textOff: this.textOff });
    ...
    var MultilineTextHeader = /** @class */ (function (_super) {
        ...
        MultilineTextHeader.prototype.drawInternal = function (value, context, style, helper, grid, _a) {
            var drawCellBase = _a.drawCellBase;
     ...
     * headers
     */
    var headers = { action: action, style: style, type: type };
    ...
    function getLinearGradient(context, left, top, right, bottom, colorStops) {
        ...
        for (var stop_1 in colorStops) {
            if (colorStops.hasOwnProperty(stop_1)) {
                stopsKey.push("".concat(stop_1, "@").concat(colorStops[stop_1]));
            }
        }
    ...
    //private symbol
    var _$1 = getThemeSymbol();
    function getProp(obj, superObj, names, defNames) {
        return (getChainSafe.apply(void 0, __spreadArray([obj], names, false)) || getChainSafe.apply(void 0, __spreadArray([superObj], names, false)) ||
            (defNames && getChainSafe.apply(void 0, __spreadArray([obj], defNames, false))) ||
            (defNames && getChainSafe.apply(void 0, __spreadArray([superObj], defNames, false))));
    }
    var Theme = /** @class */ (function () {
        ...
        Object.defineProperty(Theme.prototype, "underlayBackgroundColor", {
            get: function () {
                var obj = this[_$1].obj;
                var superTheme = this[_$1].superTheme;
        ...
        Object.defineProperty(Theme.prototype, "highlightBgColor", {
            get: function () {
                ...
                if (this.hasProperty(['highlightBgColor'])) {
                    var _a = this[_$1], obj = _a.obj, superTheme = _a.superTheme;
        ...
        Object.defineProperty(Theme.prototype, "messages", {
            get: function () {
                var _a = this[_$1], obj = _a.obj, superTheme = _a.superTheme;
    ...
    function drawSwitchButton(ctx, x, y, check, animElapsedTime, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.uncheckBgColor, uncheckBgColor = _c === void 0 ? '#FFF' : _c, _d = _b.checkBgColor, checkBgColor = _d === void 0 ? '#008CD6' : _d, _e = _b.borderColor, borderColor = _e === void 0 ? '#BFBFBF' : _e, _f = _b.btnSize, btnSize = _f === void 0 ? { width: 44, height: 22 } : _f, _g = _b.textOn, textOn = _g === void 0 ? '是' : _g, _h = _b.textOff, textOff = _h === void 0 ? '否' : _h;
        animElapsedTime =
            animElapsedTime > 1 ? 1 : animElapsedTime < 0 ? 0 : animElapsedTime;
        var borderWidth = (btnSize.height * 2) / 22;
        var fontSize = (btnSize.height * 12) / 22;
        var textMargin = (btnSize.width - btnSize.height + borderWidth) / 2 + borderWidth;
        ctx.save();
        try {
    ...
    var SimpleHeaderLayoutMap = /** @class */ (function () {
        ...
        SimpleHeaderLayoutMap.prototype._addHeaders = function (row, header, roots) {
            ...
            header.forEach(function (hd) {
                ...
                if (hd.columns) {
                    _this._addHeaders(row + 1, hd.columns, __spreadArray(__spreadArray([], roots, true), [
                        id,
                    ], false)).forEach(function (c) { return results.push(c); });
                }
                else {
                    var colDef = hd;
                    _this._columns.push({
        ...
        SimpleHeaderLayoutMap.prototype._setupHeaderSpan = function () {
            var processed = {};
            for (var row = this._headerCellIds.length - 1; row >= 0; row--) {
                var cols = this._headerCellIds[row];
                for (var col = cols.length - 1; col >= 0; col--) {
                    var cellId = cols[col];
                    if (!processed[cellId]) {
                        ...
                        if (rowSpan > 1 || colSpan > 1) {
                            var cellRange = this.getCellRange(col, row);
                            cellRange = cellMerge(cellRange, {
                                start: cellRange.start,
                                end: {
                                    col: cellRange.start.col + colSpan - 1,
                                    row: cellRange.start.row + rowSpan - 1,
                                },
                            });
                            for (var i = cellRange.start.row; i <= cellRange.end.row; i++) {
                                for (var j = cellRange.start.col; j <= cellRange.end.col; j++) {
    ...
    var MESSAGE_CLASSNAME_ME = "".concat(CLASSNAME_ME, "__message");
    var HIDDEN_CLASSNAME_ME = "".concat(CLASSNAME_ME, "--hidden");
    var SHOWN_CLASSNAME_ME = "".concat(CLASSNAME_ME, "--shown");
    ...
    var MessageElement = /** @class */ (function () {
        function MessageElement() {
            ...
            this._messageElement = rootElement.querySelector(".".concat(MESSAGE_CLASSNAME_ME));
        }
    ...
    var MESSAGE_CLASSNAME_EME = "".concat(CLASSNAME_EME, "__message");
    ...
    var MESSAGE_CLASSNAME_WME = "".concat(CLASSNAME_WME, "__message");
    ...
    var Svg = /** @class */ (function () {
        function Svg(svgCode) {
            var document = parser$1.parseFromString(svgCode, 'image/svg+xml');
    ...
    function circleToPath(circle) {
        ...
        var paths = "M".concat(cx + r, " ").concat(cy);
        for (var index = 1; index <= SEGMENTS; index++) {
            var theta = index * ANGLE;
            paths += "Q".concat(controlX(theta) + cx, " ").concat(controlY(theta) + cy, " ").concat(anchorX(theta) + cx, " ").concat(anchorY(theta) + cy);
        }
        return paths;
    }
    function getD(path) {
    ...
    function elementToPaths(el) {
        ...
        switch (el.tagName.toLowerCase()) {
            ...
            case 'g':
                ...
                break;
            default:
                window.console.warn("unsupported:".concat(el.tagName), "@ ".concat(el.innerHTML));
        }
        return path;
    }
    ...
    var Path2DShim = /** @class */ (function () {
        function Path2DShim(arg) {
            ...
            if (typeof arg === 'string') {
                ...
                this._ops = __spreadArray([], arg._ops, true);
            }
            else {
                throw new Error("Error: ".concat(typeof arg, " is not a valid argument to Path"));
            }
        }
    ...
    var FontWatchRunner = /** @class */ (function () {
        function FontWatchRunner(font, testStr) {
            ...
            this.fontRulerA_ = new FontRuler("".concat(font, ",").concat(LastResortFonts.SERIF), testStr);
            this.fontRulerB_ = new FontRuler("".concat(font, ",").concat(LastResortFonts.SANS_SERIF), testStr);
            var lastResortRulerA = new FontRuler("4px ".concat(LastResortFonts.SERIF), testStr);
            var lastResortRulerB = new FontRuler("4px ".concat(LastResortFonts.SANS_SERIF), testStr);
            //start
    ...
    var InlinePath2D = /** @class */ (function (_super) {
        ...
        InlinePath2D.prototype.draw = function (_a) {
            var ctx = _a.ctx; _a.canvasHelper; var rect = _a.rect, offset = _a.offset, offsetLeft = _a.offsetLeft, offsetRight = _a.offsetRight, offsetTop = _a.offsetTop, offsetBottom = _a.offsetBottom;
            offset++;
            var padding = {
                bottom: offsetBottom,
                left: offsetLeft,
    ...
    function buildSvgDataUrl(svg) {
        ...
        var url = "data:image/svg+xml;charset=utf-8,".concat(encodeURIComponent(data)); // svg -> base64
        return url;
    }
    ...
    var InlineSvg = /** @class */ (function (_super) {
        ...
        function InlineSvg(_a) {
            ...
            var elmWidth = !isPromise(svgElem)
                ? (_b = svgElem.getAttribute('width')) !== null && _b !== void 0 ? _b : undefined
                : undefined;
            var elmHeight = !isPromise(svgElem)
                ? (_c = svgElem.getAttribute('height')) !== null && _c !== void 0 ? _c : undefined
                : undefined;
            var context = {
                full: 0,
                em: 0,
    ...
    function buildInlines$1(icons, inline) {
        ...
        // && inline.filter(il => il instanceof Inline).length <- ?
            ...
            result.push.apply(result, inline.map(function (il) { return of(il); }).filter(isDef));
        }
        else {
            var il = of(inline);
            if (il) {
    ...
    function getThemeColor(grid) {
        ...
        var gridThemeColor = getChainSafe.apply(void 0, __spreadArray([grid.theme], names, false));
        if (!isDef(gridThemeColor)) {
            // use default theme
            return getChainSafe.apply(void 0, __spreadArray([themes.getDefault()], names, false));
        }
        ...
        return (function (args) {
            ...
            // use default theme
            defaultThemeColor =
                defaultThemeColor || getChainSafe.apply(void 0, __spreadArray([themes.getDefault()], names, false));
    ...
    var ThemeResolver = /** @class */ (function () {
        ...
        ThemeResolver.prototype.getThemeColor = function () {
            ...
            return getThemeColor.apply(void 0, __spreadArray([this._grid], name, false));
        };
        ...
        Object.defineProperty(ThemeResolver.prototype, "messages", {
            get: function () {
                var grid = this._grid;
                return (this._messages ||
                    (this._messages = {
    ...
    var SWITCH_STYLE = SwitchStyle.default;
    var INLINE_ELLIPSIS = of('\u2026');
    ...
    function getSwitchBtnSize(rect, ctx, textOn, textOff) {
        if (SWITCH_STYLE === SwitchStyle.default) {
            ...
            var w = Math.max(ctx.measureText(textOn || '是').width, ctx.measureText(textOff || '否').width) - 12;
            ctx.font = font;
            return {
                height: 22,
                width: 44 + w,
    ...
    function gridDrawSwitchBtn(ctx, rect, col, row, check, helper, info, positionOpt) {
        ...
        var textOn = info.textOn;
        var textOff = info.textOff;
        var btnSize = getSwitchBtnSize(rect, ctx, textOn, textOff);
        ctx.textAlign = textAlign;
        ctx.textBaseline = textBaseline;
        ...
        checkBgColor = helper.getColor(checkBgColor, col, row, ctx);
        borderColor = helper.getColor(borderColor, col, row, ctx);
        borderColor = style$3.toBoxArray(borderColor).find(function (v) { return v; });
        var draw = SWITCH_STYLE === SwitchStyle.default
    ...
    function strokeRect(ctx, color, left, top, width, height) {
        if (!Array.isArray(color)) {
            ...
            var borderColors = style$3.toBoxArray(color);
    ...
    var GridCanvasHelper = /** @class */ (function () {
        ...
        GridCanvasHelper.prototype.toBoxPixelArray = function (value, context, font) {
            if (typeof value === 'string' || Array.isArray(value)) {
                ...
                var box = style$3.toBoxArray(value);
                return [
        ...
        GridCanvasHelper.prototype.getTextRect = function (text, context, _a) {
            ...
            if (drawRect && ctx) {
                ...
                try {
                    ...
                    ctx.textBaseline = textBaseline;
                    ctx.font = font || ctx.font;
                    var inlines = buildInlines(icons, text);
                    if (isAllowOverflow(textOverflow) &&
                        isOverflowInlines(ctx, inlines, rect.width)) {
        ...
        GridCanvasHelper.prototype.borderSelection = function (context, option) {
            ...
            if (border.top || border.right || border.bottom || border.left) {
                this.drawBorderWithClip(context, function (ctx) {
                    ...
                    var borderColors = style$3.toBoxArray(borderColor);
                    ...
                    if (border.right && border.bottom && _this._grid.canDragSelection) {
                        ...
                        ctx.fill();
                        ctx.lineWidth = 1;
                        ctx.strokeStyle = _this.getColor(option.bgColor || _this.theme.defaultBgColor, col, row, ctx);
                        ctx.beginPath();
        ...
        GridCanvasHelper.prototype.buildSwitchBtnInline = function (check, context, option) {
            if (option === void 0) { option = {}; }
            var self = this;
            var btnSize = getSwitchBtnSize(context.getRect(), context.getContext(), option.textOn, option.textOff);
            function draw(info) {
                var col = context.col;
                var row = context.row;
    ...
    var CONTENT_CLASS_NAME = "".concat(CLASS_NAME, "__content");
    var HIDDEN_CLASS_NAME = "".concat(CLASS_NAME, "--hidden");
    var SHOWN_CLASS_NAME = "".concat(CLASS_NAME, "--shown");
    var TooltipElement = /** @class */ (function () {
        ...
        TooltipElement.prototype._attachCell = function (grid, col, row) {
            ...
            rootElement.style.top = "".concat(rootTop.toFixed(), "px");
            rootElement.style.left = "".concat(rootLeft.toFixed(), "px");
            ...
            if (rootHeight > offsetHeight) {
                ...
                if (rootTop + rootHeight > offsetHeight) {
                    ...
                    if (top <= offsetHeight - bottom) {
                        // 下边缘
                        var bTop = offsetHeight - rootHeight;
                        rootElement.style.top = "".concat(bTop.toFixed(), "px");
                    }
                        ...
                        // 上
                        var tTop = top - rootHeight;
                        rootElement.style.top = "".concat(tTop.toFixed(), "px");
                    }
                }
            }
            // 左右越界
            if (rootLeft - rootWidth / 2 < 0) {
                ...
                rootElement.style.left = "".concat(lLeft.toFixed(), "px");
            }
            else if (rootLeft + rootWidth / 2 > offsetWidth) {
                // 右
                var rLeft = offsetWidth - rootWidth / 2;
                rootElement.style.left = "".concat(rLeft.toFixed(), "px");
            }
            return true;
        };
    ...
    function _getBodyCellRange(grid, col, row) {
        var cellRange = null;
        var _a = grid[_], spanBodyOptions = _a.spanBodyOptions, layoutMap = _a.layoutMap;
        if (spanBodyOptions && row >= layoutMap.headerRowCount) {
            cellRange = { start: { col: col, row: row }, end: { col: col, row: row } };
            ...
            if ((startCol <= col && col <= endCol) ||
                ...
                if (startRow !== endRow) {
                    cellRange.start.row = Math.min(startRow, endRow);
                    cellRange.end.row = Math.max(startRow, endRow);
                }
            }
        }
        return cellRange;
    ...
    function _getCellRange(grid, col, row) {
        var _a = grid[_], layoutMap = _a.layoutMap, cellRangeMap = _a.cellRangeMap;
        var cellRange = layoutMap.getCellRange(col, row);
        if (cellRangeMap) {
            var range = cellRangeMap["".concat(col, "|").concat(row)];
            if (range) {
                cellRange = cellMerge(cellRange, range);
            }
        }
    ...
    function _updateRect(grid, col, row, context) {
        context.range = _getCellRange(grid, col, row);
        context.setRectFilter(function (rect, range) {
            var left = rect.left, right = rect.right, top = rect.top, bottom = rect.bottom;
            var _a = range.start, startCol = _a.col, startRow = _a.row, _b = range.end, endCol = _b.col, endRow = _b.row; // _getCellRange(grid, col, row) // 优化单元格渲染，减少_getCellRange调用频率
    ...
    function _getCellValue(grid, col, row) {
        ...
        if (row < grid[_].layoutMap.headerRowCount) {
            var caption = grid[_].layoutMap.getHeader(col, row).caption;
            cellValue = typeof caption === 'function' ? caption() : caption;
        }
        else {
            var field = grid[_].layoutMap.getBody(col, row).field;
    ...
    function _getContentHidden(grid, col, row) {
        ...
        if (row >= grid[_].layoutMap.headerRowCount) {
            var column = grid[_].layoutMap.getBody(col, row);
    ...
    function _hasHeaderField(grid, field) {
        var has = false;
        grid[_].layoutMap.headerObjects.forEach(function (cell) {
            if (cell.field === field) {
                has = true;
            }
        });
    ...
    function _getHeaderIcon(grid, col, row) {
        var icon = grid[_].layoutMap.getHeader(col, row).icon;
        if (icon == null) {
            return null;
        }
    ...
    function _getCellIcon(grid, col, row) {
        var icon = grid[_].layoutMap.getBody(col, row).icon;
        if (icon == null) {
            return null;
        }
    ...
    function _getHeaderIconTooltip(grid, col, row) {
        var tooltip = '';
        if (row < grid[_].layoutMap.headerRowCount) {
            var header = grid[_].layoutMap.getHeader(col, row);
    ...
    function _onDrawValue(grid, cellValue, context, _a, style, draw) {
        ...
        var drawCellBorder = function (_a) {
            var _b = _a === void 0 ? {} : _a, bgColor = _b.bgColor;
        ...
        var drawCellBase = function (_a) {
            ...
            drawCellBorder({ bgColor: bgColor });
        };
        var info = {
            ...
            getHeaderIconTooltip: function () { return _getHeaderIconTooltip(grid, col, row); },
    ...
    function _refreshHeader(grid) {
        ...
        if (protectedSpace.layout &&
            ...
            layoutMap = protectedSpace.layoutMap = new LayoutMap(new SimpleHeaderLayoutMap(((_a = protectedSpace.header) !== null && _a !== void 0 ? _a : []).concat(protectedSpace.headerExtend)));
        }
            ...
            layoutMap.headerObjects.forEach(function (cell) {
                ...
                if (cell.style) {
                    if (cell.style instanceof BaseStyle) {
                        var id = cell.style.listen(BaseStyle.EVENT_TYPE.CHANGE_STYLE, function () {
                            grid.invalidate();
                        });
    ...
    function _updatePivotHeader(grid, dataSource) {
        grid[_].headerExtend = dataSource.header;
        grid.header = grid.header;
        grid[_].cellRangeMap = dataSource.getCellRangeMap((grid.header || []).length, grid.frozenRowCount);
    }
    function _tryWithUpdateDataSource(grid, fn) {
        if (grid[_].dataSourceEventIds) {
            grid[_].dataSourceEventIds.forEach(function (id) { return grid[_].handler.off(id); });
        }
        fn(grid);
        grid[_].dataSourceEventIds = [
            grid[_].handler.on(grid[_].dataSource, PivotDataSource.EVENT_TYPE.REFRESH_HEADER, function () {
                _updatePivotHeader(grid, grid[_].dataSource);
            }),
            grid[_].handler.on(grid[_].dataSource, DataSource.EVENT_TYPE.UPDATED_LENGTH, function () {
                _refreshRowCount(grid);
            ...
            grid[_].handler.on(grid[_].dataSource, DataSource.EVENT_TYPE.REFRESH_DATA, function () {
                grid.selection.fireSelectedEvent();
                grid.invalidate();
            }),
        ];
    ...
    function _setRecords(grid, records) {
        ...
        _tryWithUpdateDataSource(grid, function () {
            ...
            var newDataSource = (grid[_].dataSource =
        ...
        _tryWithUpdateDataSource(grid, function () {
            if (dataSource) {
                if (dataSource instanceof DataSource) {
                    ...
                    if (dataSource instanceof PivotDataSource) {
                        _updatePivotHeader(grid, dataSource);
                    }
                }
                else {
                    var newDataSource = (grid[_].dataSource = new CachedDataSource(dataSource));
                    grid.addDisposable(newDataSource);
                }
            }
            else {
    ...
    function _onRangePaste(text, test) {
        ...
        for (var offsetRow = 0; offsetRow < pasteRowCount; offsetRow++) {
            ...
            var _loop_1 = function (offsetCol) {
                var _b = actionColumnsBox[actionRow][offsetCol], action = _b.action, id = _b.id;
    ...
    var ListGrid = /** @class */ (function (_super) {
        ...
        function ListGrid(options) {
            ...
            protectedSpace.cellRangeMap = undefined;
            protectedSpace.handler = new EventHandler();
            ...
            if (!isDef(options.monitorResize) || options.monitorResize === true) {
                if ((_b = window.mussel) === null || _b === void 0 ? void 0 : _b.EventInterceptor) {
                    protectedSpace.handler.on(_this.getElement(), 'sizechange', function () {
                        return _this.resize();
                    });
                }
                else {
        ...
        Object.defineProperty(ListGrid.prototype, "sortState", {
            ...
            set: function (sortState) {
                ...
                var newState = (this[_].sortState = isDef(sortState)
                    ? sortState
                    : {
                        col: -1,
                        row: -1,
        ...
        ListGrid.prototype.doChangeValue = function (col, row, changeValueCallback) {
            ...
            if (row < this[_].layoutMap.headerRowCount) {
                ...
                return then(_setCellValue(this, col, row, after_1), function (ret) {
                    if (ret) {
                        var field = _this[_].layoutMap.getBody(col, row).field;
        ...
        ListGrid.prototype.bindEventsInternal = function () {
            ...
            this.listen(LG_EVENT_TYPE.PASTE_CELL, function (e) {
                ...
                var layoutMap = _this[_].layoutMap;
        ...
        ListGrid.prototype.getAttachCellsAreaInternal = function (range) {
            ...
            if (row >= this[_].layoutMap.headerRowCount) {
                var column = this[_].layoutMap.getBody(col, row);
